...
require (
	buf.build/gen/go/antinvestor/presence/connectrpc/go v1.19.1-20250520083445-2d0e51ca1296.2
	...
	github.com/antinvestor/apis/go/device v1.51.3
	github.com/antinvestor/apis/go/notification v1.51.3
	github.com/antinvestor/apis/go/partition v1.51.3
	github.com/antinvestor/apis/go/profile v1.51.9
